...
// ============================================================
// MUTABLE STATE (updated by actions.js)
// ============================================================
...
export const STATE = {
  ...
  cart: [], // array of { cartItemId, productId, qty }
  qty: 1,
  saleSeconds: 7 * 3600 + 42 * 60 + 18,

  // Orders
  orders: [], // array of { orderId, items, status, createdAt }

  // Products (mutable, supports add/delete)
...
/**
 * Find a product by id from the mutable products list.
 * @param {number} id
 */

...
export default function ProductCard({ product }) {
  ...
  return (
    <button
      ...
      className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden text-left active:scale-[0.98] transition-all duration-150 hover:shadow-md w-full"
    >
      ...
      <div className="p-3">
        ...
        <p className="text-[#6C63FF] font-bold text-base">₹{product.price.toLocaleString()}</p>
